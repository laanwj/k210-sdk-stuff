...
#include "contrib/lax_der_parsing.c.h"
#include "contrib/lax_der_privatekey_parsing.c.h"
...
static int count = 4; /* reduced from 64 to make the tests run in reasonable time */
...
int main(int argc, char **argv) {
    ...
    printf("run_rfc6979_hmac_sha256_tests\n");
